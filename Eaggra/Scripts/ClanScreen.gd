...
func _on_leader_name_input_focus_exited():
	...
	if leader_name.strip_edges() == "":
		leader_name = "Col. Khorn"
		$InputsContainer/HBoxContainer/LeaderNameInputContainer/LeaderNameInput.text = "Col. Khorn"
...
func _on_line_edit_focus_exited():
	...
	if clan_name.strip_edges() == "":
		clan_name = "Faction E19"
		$InputsContainer/HBoxContainer/ClanNameInputContainer/ClanNameInput.text = "Faction E19"
