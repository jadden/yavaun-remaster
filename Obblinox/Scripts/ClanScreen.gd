...
func _on_leader_name_input_focus_exited():
	...
	if leader_name.strip_edges() == "":
		leader_name = "Saw'Sha"
		$InputsContainer/HBoxContainer/LeaderNameInputContainer/LeaderNameInput.text = "Saw'Sha"
...
func _on_line_edit_focus_exited():
	...
	if clan_name.strip_edges() == "":
		clan_name = "Rusty Thunder"
		$InputsContainer/HBoxContainer/ClanNameInputContainer/ClanNameInput.text = "Rusty Thunder"
